...
const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    sono_config_title: "⚙️ Minhas configurações de sono",
    ...
    plan_fazer_revisao: "Fazer revisão",
  ...
  es: {
    ...
    sono_config_title: "Configuración del sueño",
    ...
    plan_fazer_revisao: "Hacer revisión",
  ...
  en: {
    ...
    sono_config_title: "Sleep settings",
