...
const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    sentimento_label: "Como se sente:",
    gratidao_label: "Algo pelo qual está agradecida(o):",
    ...
    // Check-in questions
    q_meditacao_fe: "Fez meditação | oração | respiração",
    q_meditacao: "Fez meditação | respiração",
    q_criatividade_hobby: "Cantou | pintou | desenhou | assistiu TV",
    q_criatividade_geral: "Assistiu TV | fez algo criativo",
    q_julgada: "Se sentiu julgada(o) hoje",
    q_remedios: "Tomou remédios certinho",
    q_conversou: "Conversou com alguém presencialmente",
    q_comeu_bem: "Comeu bem hoje",
    q_coco: "Fez cocô",
    q_exercicio: "Saiu a caminhar | exercício físico",
    q_agua: "Tomou 1L água (mínimo)",
    q_dormiu: "Dormiu bem | descansou",
    q_suicida_label: "Pensamento suicida",
    q_gostou: "Fez algo que gostou hoje",
    q_metas: "Trabalhou pelas suas metas hoje",
  ...
  es: {
    ...
    sentimento_label: "Cómo te sientes:",
    gratidao_label: "Algo por lo que estás agradecido(a):",
    ...
    q_meditacao_fe: "Hizo meditación | oración | respiración",
    q_meditacao: "Hizo meditación | respiración",
    q_criatividade_hobby: "Cantó | pintó | dibujó | vio TV",
    q_criatividade_geral: "Vio TV | hizo algo creativo",
    q_julgada: "Se sintió juzgado(a) hoy",
    q_remedios: "Tomó los remedios correctamente",
    q_conversou: "Conversó con alguien presencialmente",
    q_comeu_bem: "Comió bien hoy",
    q_coco: "Hizo popó",
    q_exercicio: "Salió a caminar | ejercicio físico",
    q_agua: "Tomó 1L de agua (mínimo)",
    q_dormiu: "Durmió bien | descansó",
    q_suicida_label: "Pensamiento suicida",
    q_gostou: "Hizo algo que le gustó hoy",
    q_metas: "Trabajó por sus metas hoy",
  ...
  en: {
    ...
    sentimento_label: "How you feel:",
    gratidao_label: "Something you're grateful for:",
    ...
    q_meditacao_fe: "Did meditation | prayer | breathing",
    q_meditacao: "Did meditation | breathing",
    q_criatividade_hobby: "Sang | painted | drew | watched TV",
    q_criatividade_geral: "Watched TV | did something creative",
    q_julgada: "Felt judged today",
    q_remedios: "Took meds correctly",
    q_conversou: "Talked to someone in person",
    q_comeu_bem: "Ate well today",
    q_coco: "Had a bowel movement",
    q_exercicio: "Went for a walk | exercise",
    q_agua: "Drank 1L water (minimum)",
    q_dormiu: "Slept well | rested",
    q_suicida_label: "Suicidal thoughts",
    q_gostou: "Did something enjoyable today",
    q_metas: "Worked on your goals today",
