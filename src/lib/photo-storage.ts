...
export async function uploadToCloud(base64: string, folder: "meals" | "diary" | "avatars" | "porques"): Promise<string> {
...
export async function uploadFile(file: File, folder: "meals" | "diary" | "avatars" | "porques"): Promise<string> {
